...
> The authentication only works for all tools accessed through the main Workspace port (default: `8080`). This works for all preinstalled tools and the [Access Ports](#access-ports) feature. If you decide to expose another port of the container, please make sure to secure it with authentication as well!
