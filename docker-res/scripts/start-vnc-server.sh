...
# e.g.: /usr/bin/Xvnc :1 -auth /root/.Xauthority -depth 24 -desktop VNC -fp /usr/share/fonts/X11/misc,/usr/share/fonts/X11/Type1 -geometry 1600x900 -pn -rfbauth /root/.vnc/passwd -rfbport 5901 -rfbwait 30000
# /root/.vnc/xstartup
...
tail -f -q --pid $(cat $pidfile) /root/.vnc/*.log &
