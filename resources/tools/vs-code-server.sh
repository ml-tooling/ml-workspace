...
if [ $INSTALL_ONLY = 0 ] ; then
    ...
    /usr/local/bin/code-server --port=$PORT --allow-http --disable-telemetry --user-data-dir=$HOME/.config/Code/ --extensions-dir=$HOME/.vscode/extensions/ --auth=none /workspace/
    sleep 15
fi
